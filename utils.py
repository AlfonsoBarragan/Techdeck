...
def map_answers_to_categories(dataset):
    ...
    for column in columns_data:
        answers = dataset[column].unique()
        
        question_answers_dict = {'answers': list_to_num_dict(answers)}
        answers_key_value[index] = {'question':column, 'answers':question_answers_dict}
...
# Graphics representation for data #
